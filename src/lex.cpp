...
TokenType Scanner::getKeyword() {
    ...
    else if (buffer == "dl") return Dl;
    else if (buffer == "spl") return Spl;
    else if (buffer == "bpl") return Bpl;
    else if (buffer == "sil") return Sil;
    else if (buffer == "dil") return Dil;
    else if (buffer == "r8b") return R8b;
    else if (buffer == "r9b") return R9b;
    else if (buffer == "r10b") return R10b;
    else if (buffer == "r11b") return R11b;
    else if (buffer == "r12b") return R12b;
    else if (buffer == "r13b") return R13b;
    else if (buffer == "r14b") return R14b;
    else if (buffer == "r15b") return R15b;
    else if (buffer == "ah") return Ah;
    else if (buffer == "bh") return Bh;
    else if (buffer == "ch") return Ch;
    else if (buffer == "dh") return Dh;
