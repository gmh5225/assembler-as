...
void Token::print() {
    switch (this->type) {
        ...
        case Dl: std::cout << "dl" << std::endl; break;
        case Spl: std::cout << "spl" << std::endl; break;
        case Bpl: std::cout << "bpl" << std::endl; break;
        case Sil: std::cout << "sil" << std::endl; break;
        case Dil: std::cout << "dil" << std::endl; break;
        case R8b: std::cout << "r8b" << std::endl; break;
        case R9b: std::cout << "r9b" << std::endl; break;
        case R10b: std::cout << "r10b" << std::endl; break;
        case R11b: std::cout << "r11b" << std::endl; break;
        case R12b: std::cout << "r12b" << std::endl; break;
        case R13b: std::cout << "r13b" << std::endl; break;
        case R14b: std::cout << "r14b" << std::endl; break;
        case R15b: std::cout << "r15b" << std::endl; break;
        case Ah: std::cout << "ah" << std::endl; break;
        case Bh: std::cout << "bh" << std::endl; break;
        case Ch: std::cout << "ch" << std::endl; break;
        case Dh: std::cout << "dh" << std::endl; break;
